        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AIModelVersion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NextBestActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NextBestActions_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentimentScore = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    ...
                    AnalysisMetadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SentimentAnalyses_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SentimentAnalyses_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SentimentAnalyses_Interactions_InteractionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkflowInstances_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NextBestActions_CustomerId",
                table: "NextBestActions",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SentimentAnalyses_CaseId",
                table: "SentimentAnalyses",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_SentimentAnalyses_CustomerId",
                table: "SentimentAnalyses",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_SentimentAnalyses_InteractionId",
                table: "SentimentAnalyses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowInstances_CustomerId",
                table: "WorkflowInstances",
                column: "CustomerId");
